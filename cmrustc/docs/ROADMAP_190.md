...
- Commit `58b4090e` retains that marker as a closed compiler flag on exactly
  that trait shape. The clean pinned Rust 1.90 probe at `58b4090e` again reports zero graph, import,
  and HIR errors, 38,176 HIR items, and the exact 451-module/1,658-type/20,747-value
